...
import { Link, withRouter } from 'react-router-dom';//need withRouter to use the history.push thing
...
//need to use withRouter here or else we are not allow to use the history
//that we defined there
export default connect(null, mapDispathToProps)(withRouter(CreateProfile));
